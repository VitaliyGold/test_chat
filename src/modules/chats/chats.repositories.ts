...
export async function createNewChat(bd: PostgresDb, chat_info: ChatDto, message_info: MessageDto): Promise<void> {
    ...
    return await bd.transact(async client => {
        await client.query(`INSERT INTO 
            messages_table
            (message_content, owner_id, chat_id, message_id, watched, message_type, time_send) 
            VALUES 
            ($1, $2, $3, $4, $5, $6, $7)`, 
            [
                message_info.message_content, message_info.owner_id, message_info.chat_id, 
        ...
        await client.query(`INSERT INTO 
            chats_table
            (chat_type, owner_id, chat_name, chat_id, members_table_id) 
            VALUES 
            ($1, $2, $3, $4, $5)`, 
